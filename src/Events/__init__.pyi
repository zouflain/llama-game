...
class Render(Event): '''None or '...''''
	def __init__(self, dt: float, abs_time: float, time_step: float, window, resolution: tuple[int, int], render_size: tuple[int, int], framebuffer, view=None, **kwargs): '''Important rendering event'''
...
class CameraUpdate(Event): '''None or '...''''
...
class CombatGUITick(Event): '''None or '...''''
...
class CombatantReady(Event): '''None or '...''''
...
class AICombatantReady(Event): '''None or '...''''
	def __init__(self, eid: int, **kwargs): '''...'''

class PlayerCombatantReady(Event): '''None or '...''''
	def __init__(self, eid: int, **kwargs): '''...'''

class PlayerCombatantCommand(Event): '''None or '...''''
